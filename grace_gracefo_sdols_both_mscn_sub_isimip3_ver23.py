...
def get_sorted_file_list(directory, pattern='both_mscn_sub_isimip3_*.tif'):
    """
    ...
    def extract_date(file_path):
        ...
        # 假设文件名格式为：both_mscn_sub_isimip3_YYYYMMDD.tif
        date_str = base.replace('both_mscn_sub_isimip3_', '').replace('.tif', '')
        try:
...
def main():
    # 1) 设置目录和输出路径
    directory = 'D:/GRACE/both_mascons_rl06/isimip3/'  # 放置多时序TIF文件的目录
    output_trend_directory = 'D:/GRACE/both_mascons_rl06/isimip3_result/trend_components/'  # 趋势组分输出文件夹
    output_slope_path = 'D:/GRACE/both_mascons_rl06/isimip3_result/regression/trend_slope.tif'
    output_slope_se_path = 'D:/GRACE/both_mascons_rl06/isimip3_result/regression/trend_slope_se.tif'
    output_pvalue_path = 'D:/GRACE/both_mascons_rl06/isimip3_result/regression/trend_pvalue.tif'
