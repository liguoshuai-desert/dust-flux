...
def get_sorted_file_list(directory, pattern='csr_mscn_sub_watergap_*.tif'):
    """
    ...
    def extract_date(file_path):
        ...
        # 假设文件名格式为：csr_mscn_sub_watergap_YYYYMMDD.tif
        date_str = base.replace('csr_mscn_sub_watergap_', '').replace('.tif', '')
        try:
...
def main():
    # 1) 设置目录和输出路径
    directory = 'D:/GRACE/csr_mascons_rl0603/watergap/'  # 放置多时序TIF文件的目录
    output_trend_directory = 'D:/GRACE/csr_mascons_rl0603/watergap_result/trend_components/'  # 趋势组分输出文件夹
    output_slope_path = 'D:/GRACE/csr_mascons_rl0603/watergap_result/regression/trend_slope.tif'
    output_slope_se_path = 'D:/GRACE/csr_mascons_rl0603/watergap_result/regression/trend_slope_se.tif'
    output_pvalue_path = 'D:/GRACE/csr_mascons_rl0603/watergap_result/regression/trend_pvalue.tif'
