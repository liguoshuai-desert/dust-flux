...
def get_sorted_file_list(directory, pattern='gsfc_mscn_sub_pcrglobwb_*.tif'):
    """
    ...
    def extract_date(file_path):
        ...
        # 假设文件名格式为：gsfc_mscn_sub_pcrglobwb_YYYYMMDD.tif
        date_str = base.replace('gsfc_mscn_sub_pcrglobwb_', '').replace('.tif', '')
        try:
...
def main():
    # 1) 设置目录和输出路径
    directory = 'D:/GRACE/gsfc_mascons_rl06v2/pcrglobwb/'  # 放置多时序TIF文件的目录
    output_trend_directory = 'D:/GRACE/gsfc_mascons_rl06v2/pcrglobwb_result/trend_components/'  # 趋势组分输出文件夹
    output_slope_path = 'D:/GRACE/gsfc_mascons_rl06v2/pcrglobwb_result/regression/trend_slope.tif'
    output_slope_se_path = 'D:/GRACE/gsfc_mascons_rl06v2/pcrglobwb_result/regression/trend_slope_se.tif'
    output_pvalue_path = 'D:/GRACE/gsfc_mascons_rl06v2/pcrglobwb_result/regression/trend_pvalue.tif'
